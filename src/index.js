...
let projects = [
	...
	},
	{
        ...
        description: "This is a basic front-end React App that allows me to create attractive, dynamic web presentations on the fly. Loads quickly and supports iframes that only load once, enabling me to do quick demos on sites like Codepen.io. Use arrow keys to move forward and backward. Press the up arrow key to zoom out and view all slides at once.",
